...
useEffect(()=>{
  ...
  <div className='min-w-60'>
    ...
    {/* category filter */}
    <div className={` rounded-md border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '':'hidden'} sm:block`}>
    ...
    {/* subcategory filter */}
    <div className={`rounded-md border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '':'hidden'} sm:block`}>
